package com.marina.hexagonal.adapters.in.controller;

import com.marina.hexagonal.adapters.in.controller.mapper.CustomerMapper;
...
public class CustomerController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<Customer> findById(@PathVariable final String id){
